            ...
            public void onClick(View view) {
                ...
                if (TextUtils.isEmpty(emailText) || TextUtils.isEmpty(firstNameText) || TextUtils.isEmpty(lastNameText)
                    ...
                    if (passwordText1.equals(passwordText2)) {
                        Log.d("Sign Up", "password coresponds " + emailText + " " + firstNameText + " " + lastNameText);
                        ...
                        Call<User> call = jsonUserApi.addUser(firstNameText, lastNameText, emailText, passwordText1, strClient);
                        call.enqueue(new Callback<User>() {
                            @Override
                            public void onResponse(Call<User> call, Response<User> response) {
                                Log.d("Sign UP", "ONRESPONSE" + String.valueOf(response.body()));
                            ...
                            public void onFailure(Call<User> call, Throwable t) {
                                Log.d("Sign Up", "ONFAILURE" + emailText + " " + firstNameText + " " + lastNameText);
                                t.printStackTrace();
                            }
                        });
